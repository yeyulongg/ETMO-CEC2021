...
public class ETMOF36 {
	...
	*/
	...
	public static ProblemSet getT1(int fc, int sc) throws IOException {
		...
		prob.setHt2Type("dynamic_t1"); //The type of time-related function used to control the change of the PF
		prob.setGType("sphere_linkage5");   //The type of the landscape function
			
		((Problem)prob).setName("ETMOF36_1");
	...
	public static ProblemSet getT2(int fc, int sc) throws IOException {
		...
		((Problem)prob).setName("ETMOF36_2");
