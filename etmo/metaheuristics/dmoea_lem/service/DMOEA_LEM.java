...
import etmo.metaheuristics.dmoea_lem.MultiDirection_Prediction;
import etmo.metaheuristics.dmoea_lem.Multi_Respond_Prediction;
...
public class DMOEA_LEM extends DynamicAlgorithm {
    /**
     * Constructor
     *
     * @param problemSet
    ...
    public DMOEA_LEM(ProblemSet problemSet) {
        super(problemSet);
    ...
    public List<SolutionSet> execute() throws JMException, ClassNotFoundException,NullPointerException {
        ...
        while (evaluations < maxEvaluations) {
            ...
            for (int i = 0; i < populationSize; i++) {
                ...
                // Evaluation-算出新个体函数值
                problemSet_.get(0).dynamicEvaluate(child,generations);
                evaluations++;
